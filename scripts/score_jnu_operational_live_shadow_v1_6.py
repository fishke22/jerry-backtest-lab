...
OUT=ROOT/"live_shadow"/"results"/"jnu_operational_live_shadow_current_v1_6.json"
...
def main():
    ...
    if args.forecast_dir.exists():
        for p in sorted(args.forecast_dir.glob("*.json")):
            ...
            if f.get("analysis_draft_protocol_sha256")!=sha(DRAFT_PROTOCOL): raise RuntimeError(f"forecast {fid} analysis draft protocol SHA mismatch")
    ...
    result={
      ...
      "integrity":{"status":"PASS","forecasts_verified":integrity_forecasts,"outcomes_verified":integrity_outcomes,
                   ...
                   "risk_state_evidence_recomputed":True,"prepared_request_recomputed":True,"analysis_draft_recomputed":True,"outcomes_recomputed":True,
      ...
      "analysis_draft_protocol_sha256":sha(DRAFT_PROTOCOL),
