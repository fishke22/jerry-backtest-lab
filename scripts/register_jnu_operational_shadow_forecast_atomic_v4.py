...
REGISTRAR=ROOT/"scripts"/"register_jnu_operational_shadow_forecast_v1_7.py"
...
def main():
    ...
    required=["request_id","draft_id","request_created_at_taipei","analysis_frozen_at_taipei","request_valid_until_taipei","symbol",
              "created_at_taipei","reference_price","reference_timestamp","reference_source",
              "reference_source_metadata","risk_state_evidence","request_preparation","exact_product",
    ...
    try:
        ...
        print(json.dumps({
            "status":"FORECAST_REGISTERED_ATOMIC_V4_COMMITTED" if real else "FORECAST_REGISTERED_ATOMIC_V4_SELFTEST",
            "forecast_id":fid,
            "bias":forecast["bias"],
