...
REGISTRAR=ROOT/"scripts"/"register_jnu_operational_shadow_forecast_v1_6.py"
...
def main():
    ...
    try:
        ...
        print(json.dumps({
            "status":"FORECAST_REGISTERED_ATOMIC_V3_COMMITTED" if real else "FORECAST_REGISTERED_ATOMIC_V3_SELFTEST",
            "forecast_id":fid,
            "bias":forecast["bias"],
