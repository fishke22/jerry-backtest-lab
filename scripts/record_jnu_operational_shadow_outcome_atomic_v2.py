...
RECORDER=ROOT/"scripts"/"record_jnu_operational_shadow_outcome_v1_1.py"
...
def main():
    ...
    try:
        ...
        print(json.dumps({
            "status":"OUTCOME_RECORDED_ATOMIC_V2_COMMITTED" if real else "OUTCOME_RECORDED_ATOMIC_V2_SELFTEST",
