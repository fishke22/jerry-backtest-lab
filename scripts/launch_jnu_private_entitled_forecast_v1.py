...
ROOT=Path(__file__).resolve().parents[1];REG=ROOT/"scripts"/"register_jnu_private_entitled_forecast_v1.py"
def main():
    ...
    print(json.dumps({"status":"PRIVATE_LAUNCH_FORECAST_READY","registration_status":r["status"],"forecast_id":r["forecast_id"],"raw_and_derived_fields_not_printed":True,"public_output_created":False},indent=2))
