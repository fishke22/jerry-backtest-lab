...
FORBIDDEN_DRAFT_FIELDS={
    ...
    "risk_state_evidence","reference_price","reference_timestamp",
    "reference_source","reference_source_metadata","bias","confidence","decision_trace",
}
REQUIRED_DRAFT_FIELDS=[
    "symbol","target_day_session_date","decision_input","expected_path","key_levels",
...
def main()->None:
    ...
    evidence["request_preparation_protocol"]="config/jnu_cloud_request_preparation_protocol_v1.json"
    ...
    req={
        ...
        "request_preparation":{
            "protocol":"config/jnu_cloud_request_preparation_protocol_v1.json",
            "protocol_sha256":canonical_text_sha256(PREP_PROTOCOL),
            "request_protocol":"config/jnu_cloud_forecast_request_protocol_v1_2.json",
    ...
    print(json.dumps({
        "status":"IMMUTABLE_JNU_CLOUD_REQUEST_PREPARED",
        "request_id":rid,
        "event_state":state,
