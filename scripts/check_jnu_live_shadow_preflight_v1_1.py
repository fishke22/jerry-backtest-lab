...
from build_jnu_cloud_forecast_input_v1_1 import validate_request
...
def main():
    ...
    prepared_binding=validate_prepared_request_binding(req)
    ...
    result={
        ...
        "checks":checks,
        "request_preparation_validation":prepared_binding,
