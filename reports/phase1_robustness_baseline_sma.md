# Backtest: phase1_robustness_baseline_sma
...
- PASS — min_positive_fold_ratio
- FAIL — positive_recent
- FAIL — positive_at_2x_cost
- PASS — min_bootstrap_positive_probability

## Robustness

- Recent 126 OOS days return: -3.85%
- Positive fold ratio: 60.0%
- Worst fold return: -25.70%
- 2× cost total return: -2.86%
- Excess total return vs benchmark: -97.40%
- Bootstrap P(mean daily return > 0): 54.9%
